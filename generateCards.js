...
async function generateCards(
  ...
  try {
    ...
    const cardsPerType = {
      0: 500, // 1000 cards of card_type id = 0
      1: 500, // 1000 cards of card_type id = 1
      2: 500, // 1000 cards of card_type id = 2
      3: 500, // 1000 cards of card_type id = 3
      4: 500, // 1000 cards of card_type id = 4
      5: 500, // 1000 cards of card_type id = 5
      6: 500, // 1000 cards of card_type id = 6
      // // 7: 2, // 2 cards of card_type id = 7 //! NOT WORKING
      8: 500, // 1000 cards of card_type id = 8
      9: 500, // 1000 cards of card_type id = 9
      10: 500, // 1000 cards of card_type id = 10
    };
...
const assignCards = false; // Change to 'false' for unassigned cards
const blacklistCount = 5; // Number of cards to blacklist
const concurrencyLimit = 5; // Limit for concurrent requests per batch
let cardIdCounter = 500; // Start card ID
